    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <aside id="admin_sidebar" class="col-md-4">
            ...
            <div class="form-group">
                ...
                <a href="products.php"><input type="submit" name="update" class="btn btn-primary btn-lg" value="Update"></a>
            </div>
            ...
            <div class="form-group">
                ...
                <img width="100" height="100" src="../../resources/<?php echo $product_image; ?>" alt="">
            </div>
